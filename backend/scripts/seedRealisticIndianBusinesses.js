...
// Realistic Indian businesses for each business type
const realisticIndianBusinesses = [
  ...
  // Food Mall - Catering Services
  {
    name: "Rajesh Caterers",
    email: "rajesh@weddingcatering.com",
    password: "Demo@123456",
    businessName: "Royal Wedding Caterers",
    businessCategory: "Food Mall",
    businessType: "Catering Services",
    phone: "+91 98765 43235",
    address: {
      street: "Wedding Street, Karol Bagh",
      city: "New Delhi",
      state: "Delhi",
      zipCode: "110005",
      country: "India"
    },
    description: "Premium wedding catering with multi-cuisine options and royal presentation"
  },

  // Retail / E-Commerce - Clothing Stores
  {
    name: "Ritu Kumar",
  ...
  // Retail / E-Commerce - Furniture Stores
  {
  ...
  // Retail / E-Commerce - Electronic Shop
  {
  ...
  // Creative & Design - Printed Products
  {
    name: "Print Master",
  ...
  // Creative & Design - Logo Designers
  {
    name: "Design Studio",
  ...
  // Creative & Design - Graphic Designers
  {
    name: "Visual Arts",
  ...
  // Creative & Design - Digital Marketing Agencies
  {
    name: "Digital Boost",
...
const seedRealisticIndianBusinesses = async () => {
  try {
    // Connect to MongoDB
    ...
    const existingBusinessesCount = await User.countDocuments({ 
      email: { $in: realisticIndianBusinesses.map(b => b.email) } 
    });
    ...
    for (const businessData of realisticIndianBusinesses) {
      try {
    ...
    const categoryStats = {};
    realisticIndianBusinesses.forEach(business => {
    ...
    realisticIndianBusinesses.forEach(business => {
      ...
      stateStats[state].push(`${business.businessName} (${business.businessType})`);
    });

    Object.entries(stateStats).forEach(([state, businesses]) => {

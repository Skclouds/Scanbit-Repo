...
export const PublicRoute = ({
  ...
  if (isAuthenticated && (location.pathname === "/login" || location.pathname === "/register")) {
    // Special case: right after successful registration we want to show the success overlay
    // for a few seconds before redirecting to the dashboard.
    if (location.pathname === "/register") {
      const until = Number(sessionStorage.getItem("postRegisterOverlayUntil") || 0);
